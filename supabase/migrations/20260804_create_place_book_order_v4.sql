create or replace function public.place_book_order_v4(
...
revoke all on function public.place_book_order_v4(
  uuid, uuid, uuid, text[], text, text, text, smallint
) from public;
...
grant execute on function public.place_book_order_v4(
  uuid, uuid, uuid, text[], text, text, text, smallint
) to service_role;
