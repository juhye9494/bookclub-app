  ...
  return (
    <>
      ...
      <nav id="main-nav" className={scrolled ? 'scrolled' : ''}>
        <div className="nav-logo">한경 <span>석세스</span> 클럽</div>
        ...
        {activeBook && (
          <>
            <div className="dv-nav">
              ...
              <div className="dv-nav-title">한경 <span>석세스</span> 클럽</div>
      ...
      <div className={`modal-overlay ${isLoginOpen ? 'open' : ''}`} onClick={(e) => { if (e.target === e.currentTarget) setIsLoginOpen(false); }}>
        <div className="modal">
          ...
          <p className="modal-logo">한경 <span>석세스</span> 클럽</p>
          <h3>로그인</h3>
      ...
      <footer>
        <div className="footer-grid">
          <div>
            <p className="footer-logo">한경 <span>석세스</span> 클럽</p>
          </div>
