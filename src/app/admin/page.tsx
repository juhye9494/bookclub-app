...
export default function AdminPage() {
  ...
  useEffect(() => {
    async function checkAdminAndFetchData() {
      ...
      // 관리자 이메일 확인
      const adminEmails = ['xn940@naver.com', 'ess0317@hankyung.com', 'parkjh@hankyung.com', 'lygin729@hankyung.com', 'mama0707@hankyung.com', 'pdh0109@hankyung.com', 'shchoi@hankyung.com', 'mwd101@hankyung.com'];
