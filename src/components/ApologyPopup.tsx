  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full flex flex-col items-center text-center box-border pt-[36px] px-[28px] pb-4 flex-shrink-0">
          <span className="text-xs font-bold tracking-widest text-[#fc6640]" style={{ marginBottom: '8px' }}>
            NOTICE
          </span>

          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 break-keep" style={{ padding: '0 8px' }}>
            도서 오배송에 대한 사과 및<br/>후속 조치 안내
          </h2>
        </div>

        <div className="overflow-y-auto px-[28px] py-2 flex-1 scrollbar-hide text-left">
          <div className="flex flex-col text-[14px] sm:text-[15px] leading-[1.7] text-gray-700 break-keep w-full" style={{ gap: '16px' }}>
            <p>
        ...
        <div className="w-full flex flex-col items-center px-[28px] pb-[30px] pt-4 flex-shrink-0 border-t border-gray-100">
          <div className="flex gap-2 w-full mt-2">
            ...
            <button 
              ...
              className="flex-1 py-[14px] bg-gray-900 text-white rounded-xl font-semibold text-base shadow-lg hover:bg-gray-800 transition-colors"
            >
              1:1 문의하기
            </button>
          </div>
          ...
          <button 
            ...
            className="text-sm text-gray-400 hover:text-gray-600 underline underline-offset-4 transition-colors mt-4"
          >
            오늘 하루 보지 않기
          </button>
        </div>
